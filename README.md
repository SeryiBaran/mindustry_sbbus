...
3. Настройки клиента
   - 1 клиент установлен на 1МЕДЬ и выключен
   - 2 клиент установлен на 1СВИНЕЦ и включен
   - 3 клиент установлен на 2СТРУЧОК и выключен
   - 4 клиент установлен на 2ВЗРЫВНАЯСМЕСЬ и включен
